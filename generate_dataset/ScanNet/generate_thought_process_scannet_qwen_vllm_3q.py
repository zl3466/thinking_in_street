...
def main(args):
    ...
    for scene_idx in train_scene_idx_list:
        ...
        dataset = ScanNetDataset(data_path=train_data_path,
                                ...
                                scene_idx=scene_idx,
                                save_meta=False)
        scene_example_list = nusc_to_examples(nusc_dataset=dataset, step_size=step_size, batch_size=batch_size, video_out_dir="")
    ...
    #     step_size = random.randint(1, 10)
    #     print(f"step size: {step_size}")
    #     dataset = ScanNetDataset(data_path=test_data_path,
    #                             meta_out_path="",
    #                             scene_idx=scene_idx,
    #                             save_meta=False)
